        ...
        try {
            ...
            return interaction.editReply({
                embeds: [
                    new EmbedBuilder()
                        .setTitle("Transaction History")
                        .setDescription("An error occurred while trying to view your transaction history. Please try again later.")
                        .setColor("Red")
                        .setTimestamp()
                        .setFooter({ text: "Discord Banking", iconURL: interaction.guild.iconURL() })
                ]
            });
        }
    }
