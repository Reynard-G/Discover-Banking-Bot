...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        await client.query(`INSERT INTO transactions (user_id, amount, cr_dr, status, note, creditcard_id, created_user_id, updated_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)`, [userID, amount, "CR", 1, note, creditcardID, userID, userID]);
